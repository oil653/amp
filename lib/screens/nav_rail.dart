...
/// Modified version of the original NavigationRail, to fit Material3E more.
class Navrail extends StatefulWidget {
  ...
  /// Sets the color of the Container that holds all of the [Navrail]'s
  /// contents.
  ///
  ...
  /// Indicates that the [Navrail] should be in the extended state.
  ///
  ...
  /// a copy of the [IconThemeData.fallback] with a custom [Navrail]
  ...
  /// Overrides the default value of [Navrail]'s selection indicator color,
  ...
  /// Overrides the default value of [Navrail]'s selection indicator shape,
  /// when [useIndicator] is true.
  ///
  ...
  /// [Navrail]. Otherwise it precedes directly the main group of
  /// [destinations].
  ///
  ...
  /// [Navrail]. Otherwise it follows directly the main group of
  /// [destinations].
  ///
  /// See also [scrollable] for a description of the interplay of these
  /// parameters.
  ...
  /// Returns the animation that controls the [Navrail.extended] state.
  ///
  ...
  /// [Navrail].
  ///
  /// An instance of `MyNavigationRailFab` is created for [Navrail.leading].
  /// Pressing the FAB button toggles the "extended" state of the [Navrail].
  ///
...
class _NavrailState extends State<Navrail> with TickerProviderStateMixin {
...
class _RailDestinationState extends State<_RailDestination> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool primaryColorAlphaModified = (colors.primary.a * 255.0).round().clamp(0, 255) < 255;
